...
module Browser =
    ...
    and [<AllowNullLiteral>] WebGLVertexArrayObject =
        interface end
    
    and [<AllowNullLiteral>] WebGLSync =
        interface end
    
    and [<AllowNullLiteral>] WebGLSampler =
        interface end
    
    and [<AllowNullLiteral>] WebGL2RenderingContext =
        ...
        abstract member COPY_READ_BUFFER : float
        abstract member COPY_WRITE_BUFFER : float
        abstract member PIXEL_PACK_BUFFER : float
        abstract member PIXEL_UNPACK_BUFFER : float
        ...
        abstract member copyBufferSubData : readTarget : float * writeTarget : float * readOffset : float * writeOffset : float * size : float -> unit
